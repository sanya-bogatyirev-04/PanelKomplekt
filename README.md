...
| Кнопка | Что делает |
|---|---|
| Панель | Вставляет сэндвич-панель двумя точками; марка «буква + длина в см» обновляется сама при растягивании и копировании. |
| Спецификация | Считает панели на чертеже и сохраняет спецификацию в Excel и/или вставляет таблицу в чертёж. |
