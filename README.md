...
| Элементы | Поиск | Показывает ID выбранного объекта чертежа: по нему находится панель из предупреждения спецификации. |
...
Инструкция по каждой команде — отдельной страницей в [Docs/Commands](Docs/Commands).
Их же открывает клавиша **F1**, когда курсор наведён на кнопку команды на ленте.
Установка, обновление, удаление и решение проблем — в **[руководстве пользователя](Docs/UserGuide.md)**.
